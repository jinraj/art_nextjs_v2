...
export const artworksSyntheticData = [
    // ------------------- PAINTINGS (20) -------------------
    {
        id: 1,
...
// Mock ArtWork Data based on the provided schema
export const mockArtworks: ArtWork[] = [
  ...
  },
  {
    ...
    artType: 'Photography',
    title: 'Seascape',
    description: 'A calming seascape photo.',
    images: ['img2.png'],
    dimensions: '20x30cm',
    medium: 'Digital',
    price: 200.00,
  ...
  },
  {
    ...
    artType: 'Paintings',
    title: 'City at Night',
    description: 'An impressionist view of a city.',
    images: ['img3.png'],
    dimensions: '30x40cm',
    medium: 'Acrylic',
    price: 120.00,
  ...
  },
  {
    ...
    artType: 'Decors',
    title: 'Forest Path',
    description: 'A detailed sculpture of a forest path.',
    images: ['img4.png'],
...
export const mockOrders: Order[] = [
  {
    ...
    orderedAt: new Date(new Date().setDate(new Date().getDate() - 10)),
    updatedAt: new Date(),
  },
  {
    id: 'order_2',
