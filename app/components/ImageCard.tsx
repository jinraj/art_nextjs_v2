...
export default function ImageCard({ listOfArtworks }: ImageCardProps) {
  ...
  return (
    <div className=" text-custom-paynes-gray font-sans py-16 min-h-screen">

      {/* Gallery Grid Section */}
      <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-4 items-end">
        {listOfArtworks.map((painting, index) => (
          <div key={index} onClick={() => openPreviewModal(painting)}>
            ...
            >
              <div className="relative w-full h-[270px] md:h-[250px] lg:h-[400px]">
                <Image
